...
だから読まない。これは怠慢か？ 違う。**完璧に合理的なコスト計算**だ。限られた時間と精神エネルギーを、リターンのない行為に投じないという、正しく理に叶う判断である。
...
この「注意と感情の収奪」の機構については「[アルゴリズムの檻から脱出せよ](/mind/algorithm-intuition/)」で詳述したが、認知的降伏の文脈で重要なのはこの一点だ。**あなたの考える力は、否定されたのではない。気力が使い切らされたのだ。**
